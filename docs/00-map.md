...
| `docs/08` / `docs/09` | **Action ／技能系統分卷**：`08`＝Throw vertical slice（ADR-004 Living Spec）；`09`＝Multi-Action ／ Action Identity（ADR-005 Living Spec，⚪ 尚未裁決） | 做 Action ／技能相關工作時 |
